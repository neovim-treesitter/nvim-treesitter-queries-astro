# nvim-treesitter-queries-astro

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-astro/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-astro/actions/workflows/validate.yml)

Neovim tree-sitter queries for **astro**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-astro",
...
- [ ] Changes are scoped to `astro` — do not include files for other languages
